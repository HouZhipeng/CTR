...
from utils.layer import DenseEmbedding, OutputLayer


def dnn(sparse_field_num, sparse_index_num, dense_field_num, embed_size=8,
    ...
    """
    An implementation of DNN model in CTR problem.
    ...
    # 3. Multi-layer perception => (batch_size, 1)
    # =============================================================================================
