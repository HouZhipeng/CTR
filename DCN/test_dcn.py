...
model = dcn(sparse_field_num, sparse_index_num, dense_field_num, embed_size=embed_size,
            embeddings_initializer='uniform', embeddings_regularizer=None,
            cross_layer_num=2, mlp_activation='relu', mlp_units=(100, 100),
