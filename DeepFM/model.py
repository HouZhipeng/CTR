...
from utils.layer import sum_layer, fm_layer, OutputLayer, DenseEmbedding


def deep_fm(sparse_field_num, sparse_index_num, dense_field_num, embed_size=8,
    ...
    """
    An implementation of DeepFM model in CTR problem.
    ...
    # 4 FM part => (batch_size, 1)
    # =============================================================================================
    # (batch_size, embed_size)
    fm_cross_feat = fm_layer(name='fm_cross_feat_layer')(embed_output)
    fm_output = sum_layer(1, keepdims=True, name='fm_output_layer')(fm_cross_feat)
    ...
    outputs = OutputLayer(activation=output_activation, use_bias=output_use_bias,
                          ...
                          bias_regularizer=bias_regularizer,
                          name='output_layer'
                          )([sparse_lr_out, dense_lr_out, fm_output, mlp_output])
