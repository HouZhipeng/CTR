...
from DeepFM.model import deep_fm
...
model = deep_fm(sparse_field_num, sparse_index_num, dense_field_num, embed_size=embed_size,
                embeddings_initializer='uniform', mlp_units=(100, 100), mlp_activation='relu',
