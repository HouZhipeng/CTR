# -*- coding:utf-8 -*-
from keras.layers import Input, Dense, Embedding, Activation, Concatenate, Flatten
from keras.models import Model

from utils.layer import DenseEmbedding, OutputLayer, sum_layer


def lr_dnn(sparse_field_num, sparse_index_num, dense_field_num, embed_size=8,
    ...
    """
    An implementation of LR+DNN model in CTR problem.
    ...
    # 4. Multi-layer perception part => (batch_size, 1)
    # =============================================================================================
    ...
    outputs = OutputLayer(activation=output_activation, use_bias=output_use_bias,
                          ...
                          bias_regularizer=bias_regularizer,
                          name='output_layer'
                          )([sparse_lr_out, dense_lr_out, mlp_output])
